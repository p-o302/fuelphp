<div class="row">
    ...
    <div class="col-md-9">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="/admin/prefecture/update/<?= $prefecture->id ?>" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?= $prefecture->id ?>">
                    <div class="mb-3">
                        <label for="name" class="form-label">Prefecture Name EN</label>
                        <input type="text" class="form-control <?= isset($errors['name_en']) ? 'is-invalid' : '' ?>" id="name_en" name="name_en" placeholder="Enter Prefecture Name EN" value="<?= Input::post('name_en', $prefecture->name_en) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= isset($errors['name_jp']) ? 'is-invalid' : '' ?>" id="name_jp" name="name_jp" placeholder="Enter Prefecture Name" value="<?= Input::post('name_jp', $prefecture->name_jp) ?>">
