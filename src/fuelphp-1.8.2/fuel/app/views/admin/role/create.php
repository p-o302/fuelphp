<div class="row">
    ...
    <div class="col-md-9">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form action="/admin/role/store" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="name" class="form-label">Role Name</label>
                        <input type="text" class="form-control <?= isset($errors['name']) ? 'is-invalid' : '' ?>" id="name" name="name" placeholder="Enter Role Name" value="<?= Input::post('name', '') ?>">
